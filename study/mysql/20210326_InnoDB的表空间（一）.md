...
![2.05_记录在页中的存储](D:\study_note\maningning1.github.io\images\mysql\2.05_记录在页中的存储.png)

#### Infimum+Supremum

Infimum+Supremum部分默认创建了两条记录，为了与用户记录进行区分，Infimum记录比任何用户记录都小，Supremum记录比任何用户记录都大。

![2.06_Infimum+Supremum](D:\study_note\maningning1.github.io\images\mysql\2.06_Infimum+Supremum.png)
...
![2.07_记录在页中存储示例](D:\study_note\maningning1.github.io\images\mysql\2.07_记录在页中存储示例.png)
